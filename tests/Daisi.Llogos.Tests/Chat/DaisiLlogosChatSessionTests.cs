...
public class DaisiLlogosChatSessionTests : IDisposable
{
    ...
    public DaisiLlogosChatSessionTests()
    {
    ...
    private DaisiLlogosChatSession CreateSession(int? seed = 42)
    {
        ...
        return new DaisiLlogosChatSession(forward, _tokenizer!, renderer, stopSequences, seed);
    }

...
- [x] **11c:** Paged KV cache — dynamic allocation, no pre-allocation waste
- [x] **11d:** RAM offloading — pinned host memory pages, GPU reads via mapped pointers
...
- [x] Memory usage scales with actual context, not max context

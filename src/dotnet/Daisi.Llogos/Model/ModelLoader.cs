...
public static class ModelLoader
{
        ...
        Dictionary<string, GgufTensorInfo> tensorMap, int i)
    {
        ...
        return new StandardAttentionWeights
        {
            ...
            AttnQBias = TryLoadTensor(gguf, stream, backend, tensorMap, $"blk.{i}.attn_q.bias"),
            AttnKBias = TryLoadTensor(gguf, stream, backend, tensorMap, $"blk.{i}.attn_k.bias"),
            AttnVBias = TryLoadTensor(gguf, stream, backend, tensorMap, $"blk.{i}.attn_v.bias"),

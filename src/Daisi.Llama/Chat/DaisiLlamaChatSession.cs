...
/// <summary>
/// Multi-turn chat session backed by daisi-llama's ForwardPass and KV cache.
/// Maintains conversation history and reuses KV cache across turns by only
/// prefilling the delta (new tokens since last turn).
/// </summary>
public sealed class DaisiLlamaChatSession : IDisposable
{
